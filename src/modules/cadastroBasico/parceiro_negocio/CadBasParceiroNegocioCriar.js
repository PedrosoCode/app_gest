  ...
  return (
    <Container><h2>Criar Parceiro de Negócio</h2><Form onSubmit={handleSubmit}><Form.Group><Form.Label>Nome / Razão Social</Form.Label><Form.Control
          ...
          /></Form.Group><Form.Group><Form.Label>Tipo de Documento</Form.Label><Form.Control
            ...
            onChange={handleChange}
          ><option value="true">CNPJ</option><option value="false">CPF</option></Form.Control></Form.Group><Form.Group><Form.Label>Documento</Form.Label><ReactInputMask
            mask={getDocumentMask()}
            value={formData.documento}
            onChange={handleChange}
          >
            {(inputProps) => <Form.Control {...inputProps} type="text"name="documento" />}
          </ReactInputMask></Form.Group><Form.Group><Form.Label>Endereço</Form.Label><Form.Control
            type="text"
            name="endereco"
          ...
          /></Form.Group><Form.Group><Form.Label>Selecione o Tipo de Parceiro</Form.Label><Form.Control
            ...
            onChange={handleChange}
          ><option value="C">Cliente</option><option value="F">Fornecedor</option><option value="A">Ambos</option></Form.Control></Form.Group><Button type="submit" className="mt-3">
          Criar
